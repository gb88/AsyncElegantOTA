/*
  AsyncElegantOTA Digital Signature Example - This example will work for both ESP8266 & ESP32 microcontrollers.
  ...
  generate the private key (keep this secret):
    - openssl genrsa -out priv_key_2048.pem 2048
...
void setup(void) {
  ...
  AsyncElegantOTA.setDigitalSignature(&Hash256, &RSAVerifier);
